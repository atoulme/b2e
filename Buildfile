...
define "b2e", :version => "1.0" do
  ...
  compile.enhance [file(_('buildr/gems')), file(_('jruby.jar'))]
  package.enhance [file(_('buildr/gems')), file(_('jruby.jar'))]
  compile.with JRUBY, ECLIPSE_PLUGINS
